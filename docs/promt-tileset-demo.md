Dados estos códigos y descripciones de tiles, agrupados por tilesets, y teniendo en cuenta que la codificación son dos valores "xy" en hexadecimal en donde "x" va de 0 a 8 e "y" va de 0 a F.
Es decir, que los siguientes tiles se ubican en una matrix tileset de dimensión 9 de ancho por 16 de alto.
...
Genérame la imagen tileset en donde cada tile mida 32 x 32 pixeles. Es decir, la imagen debe ser de 288 x 512.
