...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\IRenderer' => \App\Services\RendererService::class,
            'App\Services\DatabaseTable\Contracts\DatabaseTableServiceInterface' => \App\Services\DatabaseTable\DatabaseTableService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Emilio\Desktop\GameCore\public\storage' => 'string',
            ...
            'ide-helper.type_overrides.double' => 'string',
            'ide-helper.type_overrides.real' => 'string',
            ...
            'ide-helper-config-example.filename' => 'string',
            'ide-helper-config-example.format' => 'string',
            'ide-helper-config-example.meta_filename' => 'string',
            'ide-helper-config-example.include_fluent' => 'boolean',
            'ide-helper-config-example.write_model_magic_where' => 'boolean',
            'ide-helper-config-example.write_model_external_builder_methods' => 'boolean',
            'ide-helper-config-example.write_model_relation_count_properties' => 'boolean',
            'ide-helper-config-example.write_eloquent_model_mixins' => 'boolean',
            'ide-helper-config-example.include_helpers' => 'boolean',
            'ide-helper-config-example.helper_files' => 'array',
            'ide-helper-config-example.model_locations' => 'array',
            'ide-helper-config-example.ignored_models' => 'array',
            'ide-helper-config-example.extra.Eloquent' => 'array',
            'ide-helper-config-example.extra.Session' => 'array',
            'ide-helper-config-example.magic' => 'array',
            'ide-helper-config-example.interfaces' => 'array',
            'ide-helper-config-example.custom_db_types' => 'array',
            'ide-helper-config-example.model_camel_case_properties' => 'boolean',
            'ide-helper-config-example.type_overrides.integer' => 'string',
            'ide-helper-config-example.type_overrides.boolean' => 'string',
            'ide-helper-config-example.type_overrides.double' => 'string',
            'ide-helper-config-example.type_overrides.real' => 'string',
            'ide-helper-config-example.include_class_docblocks' => 'boolean',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Emilio\\Desktop\\GameCore\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.interfaces','ide-helper.model_camel_case_properties','ide-helper.type_overrides.integer','ide-helper.type_overrides.boolean','ide-helper.type_overrides.double',
'ide-helper.type_overrides.real','ide-helper.include_class_docblocks','ide-helper.force_fqn','ide-helper.use_generics_annotations','ide-helper.macro_default_return_types.Illuminate\\Http\\Client\\Factory',
...
'ide-helper.custom_db_types','ide-helper-config-example.filename','ide-helper-config-example.format','ide-helper-config-example.meta_filename','ide-helper-config-example.include_fluent',
'ide-helper-config-example.write_model_magic_where','ide-helper-config-example.write_model_external_builder_methods','ide-helper-config-example.write_model_relation_count_properties','ide-helper-config-example.write_eloquent_model_mixins','ide-helper-config-example.include_helpers',
'ide-helper-config-example.helper_files','ide-helper-config-example.model_locations','ide-helper-config-example.ignored_models','ide-helper-config-example.extra.Eloquent','ide-helper-config-example.extra.Session',
'ide-helper-config-example.magic','ide-helper-config-example.interfaces','ide-helper-config-example.custom_db_types','ide-helper-config-example.model_camel_case_properties','ide-helper-config-example.type_overrides.integer',
'ide-helper-config-example.type_overrides.boolean','ide-helper-config-example.type_overrides.double','ide-helper-config-example.type_overrides.real','ide-helper-config-example.include_class_docblocks','logging.default',
...
'session.same_site','session.partitioned','tables.ignore','tables.ignore_patterns','broadcasting.default',
...
'sanctum.csrf-cookie','root','register','login',
'all','public','play',
'res','event','storage.local',);
...
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url',
'C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.Emilio.Desktop.GameCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','FAKE_USERS_PASSWORD',
'ADMIN_USERNAME','ADMIN_EMAIL','ADMIN_PASSWORD','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS',
